...
console.log(`- área de um losango que tem D = 32cm e d = 18cm;: ${Ex.getDiamondArea(32, 18)}`);
console.log(`- área de um losango que tem D = 200cm e d = 50cm;: ${Ex.getDiamondArea(200, 50)}`);
console.log(`- área de um losango que tem D = 75cm e d = 25cm;: ${Ex.getDiamondArea(75, 25)}`);
console.log(`Area de um trapézio que tem B = 100cm, b = 70cm e altura = 50cm; ${Ex.getTrapezeArea(50, 70, 100)}`);
console.log(`Area de um trapézio que tem B = 75cm, b = 50cm e altura = 35cm; ${Ex.getTrapezeArea(35, 50, 75)}`);
console.log(`Area de um trapézio que tem B = 150cm, b = 120cm e altura = 80cm; ${Ex.getTrapezeArea(80, 120, 150)}`);
console.log(`área de um círculo de raio igual 25cm ${Ex.getCircleArea(25)}`);
console.log(`área de um círculo de raio igual 100cm ${Ex.getCircleArea(100)}`);
console.log(`área de um círculo de raio igual 12,5cm ${Ex.getCircleArea(12.5)}`);
