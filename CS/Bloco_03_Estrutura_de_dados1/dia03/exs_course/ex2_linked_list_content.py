from ex1_implementando_node import Node
...
if __name__ == "__main__":
    ...
    print(
        linked_list
    )  # saída: LinkedList(len=2 value=Node(value=2 next=Node(value=1
    # next=None)))
    ...
    print(
        linked_list
    )  # saída: LinkedList(len=2 value=Node(value=1 next=Node(value=5
    # next=None)))
