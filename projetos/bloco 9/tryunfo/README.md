...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-024-a-project-tryunfo.git`.
  ...
  - Agora crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    - Exemplo: `git checkout -b joaozinho-sd-024-a-project-tryunfo`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-sd-024-a-project-tryunfo`

  6. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-024-a-project-tryunfo/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-024-a-project-tryunfo/pulls) e confira que o seu _Pull Request_ está criado
