...
describe('2 - Crie um botão chamado `Próximo pokémon` para percorrer todos os pokémon da lista', () => {
  ...
  it('Será verificado se, ao clicar no botão `Próximo pokémon` as informações do próximo pokémon da lista são exibidas', () => {
...
describe('3 - Faça com que, quando o último pokémon da lista estiver sendo exibido, ao clicar no botão `Próximo pokémon` o primeiro pokémon da lista seja exibido novamente', () => {
  ...
  it('Será verificado se, quando o último pokémon da lista estiver sendo exibido, ao clicar no botão `Próximo pokémon` o primeiro pokémon da lista é exibido novamente', () => {
    pokemonList.forEach((pokemon) => {
      verifyIfPokemonExistsOnScreen(pokemon);
...
describe('4 - Crie dois botões de filtro, de forma que, quando algum deles for clicado, apenas os pokémon do respectivo tipo filtrado sejam exibidos', () => {
  ...
  it('Será verificado se, ao clicar no botão de filtro `Fire`, o primeiro pokémon do tipo `Fire` será exibido imediatamente', () => {
  ...
  it('Será verificado se, com o filtro `Fire` ativo, somente os pokémon do tipo `Fire` serão exibidos ao clicar no botão `Próximo pokémon`', () => {
    ...
    fireTypePokemonList.forEach((firePokemon) => {
  ...
  it('Será verificado se, ao clicar no botão de filtro `Psychic`, o primeiro pokémon do tipo `Psychic` será exibido imediatamente', () => {
  ...
  it('Será verificado se, com o filtro `Psychic` ativo, somente os pokémon do tipo `Psychic` serão exibidos ao clicar no botão `Próximo pokémon`', () => {
    ...
    psychicTypePokemonList.forEach((psychicPokemon) => {
